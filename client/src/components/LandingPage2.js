    ...
    <div className="landing-page">
      ...
      <nav className="university-nav">
        <div className="nav-container">
          <Link to="/amity" className="nav-link">Amity University</Link>
          <span className="nav-separator">|</span>
          <Link to="/vit" className="nav-link active">VIT University</Link>
        </div>
      </nav>
      ...
      <section id="lead-form-section" className="content-section form-section">
        <div className="container">
          <LeadForm universityId="vit" universityName={universityData.name} />
        </div>
      </section>
